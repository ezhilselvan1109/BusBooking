...
public class Register extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			PreparedStatement preparedStatement = connection.prepareStatement("insert into travel_agency (agency_name,agency_contact,agency_email,agent_username,agent_password) values (? , ? , ? , ?, ?)");
